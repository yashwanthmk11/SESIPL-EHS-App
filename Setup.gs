...
function initializeSystem() {
  ...
  try {
    ...
    const orgSeeds = [
      { id: uid_('ORG'), projectId: p1, level: '1', roleTitle: 'Director', name: 'Mr. Shankar', phone: '+91 98450 11001', email: 'director@sesipl.com' },
      { id: uid_('ORG'), projectId: p1, level: '2', roleTitle: 'General Manager', name: 'Mr. C. Shekhar', phone: '+91 98450 22002', email: 'gm@sesipl.com' },
      { id: uid_('ORG'), projectId: p1, level: '3', roleTitle: 'Project Manager', name: 'HR Ravikiran', phone: '+91 98450 33003', email: 'ravikiran@sesipl.com' },
      { id: uid_('ORG'), projectId: p1, level: '4', roleTitle: 'HSE Officer / In charge', name: 'Mr. Harish', phone: '+91 98450 44004', email: 'harish.ehs@sesipl.com' },
      { id: uid_('ORG'), projectId: p1, level: '5', roleTitle: 'Project Engineer', name: 'P. Naveen', phone: '+91 98450 55005', email: 'naveen.pe@sesipl.com' },

      { id: uid_('ORG'), projectId: p2, level: '1', roleTitle: 'Director', name: 'Mr. Shankar', phone: '+91 98450 11001', email: 'director@sesipl.com' },
      { id: uid_('ORG'), projectId: p2, level: '2', roleTitle: 'General Manager', name: 'Mr. C. Shekhar', phone: '+91 98450 22002', email: 'gm@sesipl.com' },
      { id: uid_('ORG'), projectId: p2, level: '3', roleTitle: 'Project Manager', name: 'K. Sharma', phone: '+91 98450 33006', email: 'sharma@sesipl.com' },
      { id: uid_('ORG'), projectId: p2, level: '4', roleTitle: 'HSE Officer / In charge', name: 'S. Rajesh', phone: '+91 98450 44007', email: 'rajesh.ehs@sesipl.com' },
      { id: uid_('ORG'), projectId: p2, level: '5', roleTitle: 'Project Engineer', name: 'M. Karthik', phone: '+91 98450 55008', email: 'karthik.pe@sesipl.com' },

      { id: uid_('ORG'), projectId: p3, level: '1', roleTitle: 'Director', name: 'Mr. Shankar', phone: '+91 98450 11001', email: 'director@sesipl.com' },
      { id: uid_('ORG'), projectId: p3, level: '2', roleTitle: 'General Manager', name: 'Mr. C. Shekhar', phone: '+91 98450 22002', email: 'gm@sesipl.com' },
      { id: uid_('ORG'), projectId: p3, level: '3', roleTitle: 'Project Manager', name: 'HR Ravikiran', phone: '+91 98450 33003', email: 'ravikiran@sesipl.com' },
      { id: uid_('ORG'), projectId: p3, level: '4', roleTitle: 'HSE Officer / In charge', name: 'V. Murugan', phone: '+91 98450 44009', email: 'murugan.ehs@sesipl.com' },
      { id: uid_('ORG'), projectId: p3, level: '5', roleTitle: 'Project Engineer', name: 'S. Vignesh', phone: '+91 98450 55010', email: 'vignesh.pe@sesipl.com' },

      { id: uid_('ORG'), projectId: p4, level: '1', roleTitle: 'Director', name: 'Mr. Shankar', phone: '+91 98450 11001', email: 'director@sesipl.com' },
      { id: uid_('ORG'), projectId: p4, level: '2', roleTitle: 'General Manager', name: 'Mr. C. Shekhar', phone: '+91 98450 22002', email: 'gm@sesipl.com' },
      { id: uid_('ORG'), projectId: p4, level: '3', roleTitle: 'Project Manager', name: 'K. Sharma', phone: '+91 98450 33006', email: 'sharma@sesipl.com' },
      { id: uid_('ORG'), projectId: p4, level: '4', roleTitle: 'HSE Officer / In charge', name: 'A. Reddy', phone: '+91 98450 44011', email: 'reddy.ehs@sesipl.com' },
      { id: uid_('ORG'), projectId: p4, level: '5', roleTitle: 'Project Engineer', name: 'T. Venkat', phone: '+91 98450 55012', email: 'venkat.pe@sesipl.com' }
    ];

    // Slide 8 Standard Daily Logs
    const logs = [
      { id: uid_('DL'), projectId: p1, date: '2026-09-15', staff: '6', workers: '48', totalManpower: '54', workingHours: '8', totalManHours: '432', safeManHours: '432', cumSafeManHours: '370840', inductions: '5', indStaff: '1', indWorkers: '4', tbtCount: '3', tbtPersons: '48', trainingTopic: 'Earth pit excavation & isolation', trainingPersons: '18', permitHot: '2', permitElectrical: '4', permitCold: '1', permitGeneral: '3', permitOthers: '0', firstAid: '0', nearMiss: '0', ltiCount: '0', accidentDetails: 'Nil - Safe day', remarks: 'Good site housekeeping maintained', enteredBy: 'EMP001', verifiedBy: 'Ravikiran', approvedBy: 'Mr. Shankar' },
      { id: uid_('DL'), projectId: p2, date: '2026-09-15', staff: '4', workers: '38', totalManpower: '42', workingHours: '8', totalManHours: '336', safeManHours: '336', cumSafeManHours: '215420', inductions: '3', indStaff: '0', indWorkers: '3', tbtCount: '2', tbtPersons: '38', trainingTopic: 'Cable laying and tray installation', trainingPersons: '14', permitHot: '1', permitElectrical: '3', permitCold: '0', permitGeneral: '2', permitOthers: '0', firstAid: '0', nearMiss: '0', ltiCount: '0', accidentDetails: 'Nil - Safe day', remarks: 'Cable puller PPE inspected', enteredBy: 'EMP002', verifiedBy: 'K. Sharma', approvedBy: 'Mr. Shankar' },
      { id: uid_('DL'), projectId: p3, date: '2026-09-15', staff: '8', workers: '60', totalManpower: '68', workingHours: '8', totalManHours: '544', safeManHours: '544', cumSafeManHours: '410290', inductions: '6', indStaff: '2', indWorkers: '4', tbtCount: '4', tbtPersons: '60', trainingTopic: 'Working at height & full-body harness', trainingPersons: '24', permitHot: '3', permitElectrical: '5', permitCold: '2', permitGeneral: '4', permitOthers: '1', firstAid: '1', nearMiss: '1', ltiCount: '0', accidentDetails: 'Minor finger scrape; treated with first aid kit', remarks: 'First aid kit replenished', enteredBy: 'EMP005', verifiedBy: 'Ravikiran', approvedBy: 'Mr. Shankar' },
      { id: uid_('DL'), projectId: p4, date: '2026-09-15', staff: '10', workers: '70', totalManpower: '80', workingHours: '8', totalManHours: '640', safeManHours: '640', cumSafeManHours: '280150', inductions: '8', indStaff: '1', indWorkers: '7', tbtCount: '4', tbtPersons: '70', trainingTopic: 'Substation panel commissioning & LOTO', trainingPersons: '28', permitHot: '2', permitElectrical: '6', permitCold: '1', permitGeneral: '5', permitOthers: '0', firstAid: '0', nearMiss: '0', ltiCount: '0', accidentDetails: 'Nil - Safe day', remarks: 'Substation room entry controlled', enteredBy: 'EMP003', verifiedBy: 'K. Sharma', approvedBy: 'Mr. Shankar' }
    ];

    // Slide 11 Master Tracker of Scaffolding & Ladders
    const scf = [
      { id: uid_('SCF'), projectId: p1, date: '2026-09-15', region: 'Bangalore', sharavFab: '10', sesipl: '4', vinayaka: '2', hbs: '3', other: '0', totalScaffold: '14', ladderSharav: '12', ladderSesipl: '0', ladderVinayaka: '0', ladderHbs: '0', ladderRental: '0', airportLadder: '2', workstationLadder: '2', frpMsafe: '3', frpYoungman: '2', totalLadder: '9', returnedScaffold: '5', returnedLadder: '3', remarks: '14 Scaffolds in site; 9 Ladders in site', enteredBy: 'EMP001' },
      { id: uid_('SCF'), projectId: p2, date: '2026-09-15', region: 'Bangalore', sharavFab: '6', sesipl: '3', vinayaka: '1', hbs: '2', other: '0', totalScaffold: '12', ladderSharav: '6', ladderSesipl: '2', ladderVinayaka: '0', ladderHbs: '0', ladderRental: '2', airportLadder: '1', workstationLadder: '1', frpMsafe: '2', frpYoungman: '2', totalLadder: '8', returnedScaffold: '2', returnedLadder: '1', remarks: 'Periodic inspection completed', enteredBy: 'EMP002' },
      { id: uid_('SCF'), projectId: p3, date: '2026-09-15', region: 'Chennai', sharavFab: '8', sesipl: '4', vinayaka: '1', hbs: '2', other: '0', totalScaffold: '15', ladderSharav: '0', ladderSesipl: '0', ladderVinayaka: '0', ladderHbs: '0', ladderRental: '0', airportLadder: '0', workstationLadder: '0', frpMsafe: '0', frpYoungman: '0', totalLadder: '0', returnedScaffold: '0', returnedLadder: '0', remarks: '15 Scaffolds in site', enteredBy: 'EMP005' },
      { id: uid_('SCF'), projectId: p4, date: '2026-09-15', region: 'Hyderabad', sharavFab: '5', sesipl: '2', vinayaka: '3', hbs: '0', other: '0', totalScaffold: '10', ladderSharav: '6', ladderSesipl: '0', ladderVinayaka: '0', ladderHbs: '0', ladderRental: '8', airportLadder: '2', workstationLadder: '2', frpMsafe: '4', frpYoungman: '4', totalLadder: '14', returnedScaffold: '0', returnedLadder: '0', remarks: '10 Scaffolds in site; 14 Ladders in site', enteredBy: 'EMP003' }
    ];

    // Slide 10 PPE Stock Register Data
    const ppeSeeds = [
      { id: uid_('PPE'), projectId: p1, date: '2026-09-15', contractor: 'Vinayaka Electricals', receivedBy: 'R. Prakash', helmetWhite: '3', helmetGreen: '2', helmetBlue: '3', helmetRed: '2', jacketGreen: '3', jacketOrange: '4', cottonGloves: '20', leatherGloves: '8', goggle: '15', faceShield: '4', mask: '30', apron: '2', shoulderPad: '2', earMuff: '4', dcNo: '274', totalReceived: '10', returnable: 'Yes', balanceStock: '8', remarks: 'Store In-charge: Mr. Harish', enteredBy: 'EMP001' },
      { id: uid_('PPE'), projectId: p2, date: '2026-09-15', contractor: 'Apex Infra', receivedBy: 'S. Kumar', helmetWhite: '4', helmetGreen: '2', helmetBlue: '2', helmetRed: '0', jacketGreen: '2', jacketOrange: '4', cottonGloves: '15', leatherGloves: '6', goggle: '10', faceShield: '2', mask: '25', apron: '0', shoulderPad: '0', earMuff: '2', dcNo: '281', totalReceived: '12', returnable: 'Yes', balanceStock: '9', remarks: 'Store In-charge: S. Rajesh', enteredBy: 'EMP002' },
      { id: uid_('PPE'), projectId: p3, date: '2026-09-15', contractor: 'Sharav Power', receivedBy: 'T. Murthy', helmetWhite: '5', helmetGreen: '3', helmetBlue: '4', helmetRed: '2', jacketGreen: '4', jacketOrange: '6', cottonGloves: '30', leatherGloves: '12', goggle: '20', faceShield: '6', mask: '40', apron: '4', shoulderPad: '4', earMuff: '6', dcNo: '295', totalReceived: '18', returnable: 'Yes', balanceStock: '14', remarks: 'Store In-charge: V. Murugan', enteredBy: 'EMP005' },
      { id: uid_('PPE'), projectId: p4, date: '2026-09-15', contractor: 'Southern Tech', receivedBy: 'G. Naidu', helmetWhite: '4', helmetGreen: '4', helmetBlue: '3', helmetRed: '1', jacketGreen: '5', jacketOrange: '5', cottonGloves: '25', leatherGloves: '10', goggle: '18', faceShield: '4', mask: '35', apron: '2', shoulderPad: '2', earMuff: '5', dcNo: '304', totalReceived: '15', returnable: 'Yes', balanceStock: '11', remarks: 'Store In-charge: A. Reddy', enteredBy: 'EMP003' }
    ];

    // Slide 15 Audit Scores
    const auditSeeds = [
      { id: uid_('ADT'), projectId: p1, auditDate: '2026-09-10', auditor: 'CBRE Lead Auditor', location: 'Intuit Bellandur', totalScore: '485', maxScore: '500', percent: '97', grade: 'A+', status: 'APPROVED', submittedBy: 'EMP003' },
      { id: uid_('ADT'), projectId: p2, auditDate: '2026-09-08', auditor: 'Cushman Auditor', location: 'Siemens E-City', totalScore: '460', maxScore: '500', percent: '92', grade: 'A', status: 'APPROVED', submittedBy: 'EMP003' },
      { id: uid_('ADT'), projectId: p3, auditDate: '2026-09-12', auditor: 'JLL EHS Auditor', location: 'Qualcomm Chennai', totalScore: '475', maxScore: '500', percent: '95', grade: 'A', status: 'APPROVED', submittedBy: 'EMP003' },
      { id: uid_('ADT'), projectId: p4, auditDate: '2026-09-05', auditor: 'Turner Auditor', location: 'Infosys Hyderabad', totalScore: '450', maxScore: '500', percent: '90', grade: 'A', status: 'APPROVED', submittedBy: 'EMP003' }
    ];

    // Audit Section Scores Breakdown
    const auditScoreSeeds = [
      { id: uid_('AS'), auditId: auditSeeds[0].id, section: 'A', sn: '1', particulars: 'EHS Policy Displayed at Site Entrance', score: '5', remarks: 'Bilingual display in English and Kannada' },
      { id: uid_('AS'), auditId: auditSeeds[0].id, section: 'A', sn: '2', particulars: 'EHS Organization Chart with Emergency Contacts', score: '5', remarks: 'Verified contact numbers active' },
      { id: uid_('AS'), auditId: auditSeeds[0].id, section: 'H', sn: '1', particulars: 'Drinking Water & Rest Area Facilities', score: '5', remarks: 'RO water dispenser clean with test report' },
      { id: uid_('AS'), auditId: auditSeeds[0].id, section: 'P', sn: '1', particulars: 'Hot Work Permit & Fire Watcher Deployed', score: '5', remarks: 'Fire extinguisher inspected with green tag' },
      { id: uid_('AS'), auditId: auditSeeds[1].id, section: 'A', sn: '1', particulars: 'EHS Policy Displayed at Site Entrance', score: '5', remarks: 'Displayed at safety induction room' },
      { id: uid_('AS'), auditId: auditSeeds[2].id, section: 'N', sn: '1', particulars: 'Scaffold Inspection & Tagging System', score: '5', remarks: 'All green tagged and signed' }
    ];

    // Seed Realistic Observations
    const obsSeeds = [
      { id: uid_('OBS'), projectId: p1, reportNo: 'OBS-001', date: '2026-09-15', vendor: 'Vinayaka Electricals', auditedBy: 'Harish (Lead)', location: 'Floor 3 - DB Room', contractor: 'Vinayaka Electricals', observation: 'Work at height without double lanyard safety harness', preventive: 'Issued warning and provided standard EN-361 full body harness with shock absorber', status: 'OPEN', ownerEmployeeId: 'EMP001', dueAt: '2026-09-17 18:00', escalateAt: '2026-09-18 18:00', fallbackNote: '', fallbackAt: '', unsafeFileId: '', rectifiedFileId: '', submittedBy: 'EMP001' },
      { id: uid_('OBS'), projectId: p1, reportNo: 'OBS-002', date: '2026-09-14', vendor: 'Apex Infra', auditedBy: 'Harish (Lead)', location: 'Basement Substation', contractor: 'Apex Infra', observation: 'Temporary cables laid across pedestrian walkway without rubber ramp protection', preventive: 'Rerouted overhead and installed heavy duty cable ramp protector', status: 'APPROVED', ownerEmployeeId: 'EMP001', dueAt: '2026-09-15 18:00', escalateAt: '2026-09-16 18:00', fallbackNote: '', fallbackAt: '', unsafeFileId: '', rectifiedFileId: '', submittedBy: 'EMP001' },
      { id: uid_('OBS'), projectId: p2, reportNo: 'OBS-003', date: '2026-09-15', vendor: 'Apex Infra', auditedBy: 'S. Rajesh (Lead)', location: 'Block B Ground Floor', contractor: 'Apex Infra', observation: 'Portable angle grinder guard removed during conduit cutting', preventive: 'Work stopped immediately; wheel guard and deadman switch re-installed', status: 'SUBMITTED', ownerEmployeeId: 'EMP002', dueAt: '2026-09-16 18:00', escalateAt: '2026-09-17 18:00', fallbackNote: '', fallbackAt: '', unsafeFileId: '', rectifiedFileId: '', submittedBy: 'EMP002' },
      { id: uid_('OBS'), projectId: p3, reportNo: 'OBS-004', date: '2026-09-13', vendor: 'Sharav Power', auditedBy: 'V. Murugan (Lead)', location: 'Terrace Cable Tray', contractor: 'Sharav Power', observation: 'Static lifeline slackness noticed across 12m span', preventive: 'Tensioned lifeline with turnbuckle and verified anchor points', status: 'CLOSED', ownerEmployeeId: 'EMP005', dueAt: '2026-09-14 18:00', escalateAt: '2026-09-15 18:00', fallbackNote: '', fallbackAt: '', unsafeFileId: '', rectifiedFileId: '', submittedBy: 'EMP005' }
    ];

    // Seed Interactive Notifications for Mobile-Style Notification Tray
    const notifSeeds = [
      { id: uid_('NTF'), toEmployeeId: 'EMP001', projectId: p1, title: 'Safety Audit Score: 97% (Grade A+)', body: 'Intuit Bellandur scored 97% on client monthly audit.', type: 'AUDIT', read: 'FALSE', createdAt: nowIso_(), createdBy: 'EMP003' },
      { id: uid_('NTF'), toEmployeeId: 'EMP001', projectId: p1, title: 'Observation OBS-001 Open', body: 'Floor 3 DB Room safety observation pending corrective action verification.', type: 'OBSERVATION', read: 'FALSE', createdAt: nowIso_(), createdBy: 'EMP001' },
      { id: uid_('NTF'), toEmployeeId: 'EMP002', projectId: p2, title: 'Weekly EHS Report Review', body: 'Siemens E-City weekly report ready for Asst Manager review.', type: 'REPORT', read: 'FALSE', createdAt: nowIso_(), createdBy: 'EMP003' },
      { id: uid_('NTF'), toEmployeeId: 'EMP003', projectId: p3, title: 'Scaffold Inspection Passed', body: 'Qualcomm Chennai 15 scaffolds certified green tagged.', type: 'SCAFFOLD', read: 'FALSE', createdAt: nowIso_(), createdBy: 'EMP005' },
      { id: uid_('NTF'), toEmployeeId: 'EMP004', projectId: p1, title: 'Zero LTI Safety Milestone', body: 'Cumulative safe man-hours reached 370,840 hrs with zero lost time injuries.', type: 'MILESTONE', read: 'FALSE', createdAt: nowIso_(), createdBy: 'SYSTEM' }
    ];

    // Seed Training Calendar
    const trainingSeeds = [
      { id: uid_('TRN'), projectId: p1, date: '2026-09-18', topic: 'LOTO (Lockout / Tagout) Procedures', owner: 'Harish', dept: 'Electrical Fit-Out', status: 'SCHEDULED', notes: 'Mandatory for all panel technicians', createdBy: 'EMP001' },
      { id: uid_('TRN'), projectId: p2, date: '2026-09-20', topic: 'Emergency Evacuation & Fire Drill', owner: 'S. Rajesh', dept: 'Site Wide', status: 'SCHEDULED', notes: 'Assembly point B coordination', createdBy: 'EMP002' },
    ...
    batchWriteObjects_(sheetMap[SHEETS.PROJECT_USERS], HEADERS.ProjectUsers, projectUserRows);
    batchWriteObjects_(sheetMap[SHEETS.PROJECT_ORG], HEADERS.ProjectOrgChart, orgSeeds);
    batchWriteObjects_(sheetMap[SHEETS.FORM_CATALOG], HEADERS.FormCatalog, FORM_DEFS);
    ...
    batchWriteObjects_(sheetMap[SHEETS.AUDIT_SCORES], HEADERS.AuditScores, auditScoreSeeds);
