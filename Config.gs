...
const HEADERS = {
  ...
  PpeIssue: ['id', 'projectId', 'date', 'itemCategory', 'contractor', 'receivedBy', 'helmetWhite', 'helmetGreen', 'helmetBlue', 'helmetRed', 'jacketGreen', 'jacketOrange', 'cottonGloves', 'leatherGloves', 'goggle', 'faceShield', 'mask', 'apron', 'shoulderPad', 'earMuff', 'dcNo', 'totalReceived', 'issuedQty', 'returnable', 'balanceStock', 'storeIncharge', 'remarks', 'enteredBy'],
...
const FORM_DEFS = [
  ...
  { formCode: 'WP_UPLOAD', module: 'PERMIT', title: 'Work Permit File Upload (Signed PTW Scan / Copy)', cadence: 'AS_REQUIRED', entryType: 'UPLOAD', slaHours: 0 },
